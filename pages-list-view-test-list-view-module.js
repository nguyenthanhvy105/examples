...
var ListViewBasicComponent = /** @class */ (function () {
    ...
    ListViewBasicComponent.prototype.clear = function () {
        var _this = this;
        this.dataService.getPeople().subscribe(function (items) {
            _this.peoples = [items[5], items[6], items[10]];
...
/* harmony import */ var _common_example_common_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../common/example-common.module */ "./src/app/pages/common/example-common.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    TestListViewModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: [
                ...
                _common_example_common_module__WEBPACK_IMPORTED_MODULE_6__["ExampleCommonModule"],
